...
prepare_analysis_data_species <- function(
  ...
  observed_winters |>
    ...
    write_vc(
      ...
      root = analysis_data, sorting = c("location_id", "winter")
    )
...
the location consist of a single sublocation.",
        this_species$scientific_name, n_winter, start
      ),
      field_description = c(
...
starts at %s.",
        this_species$scientific_name, n_present, start
      ),
      field_description = c(
        location_id = "The identifier of the location.",
...
dataset starts at %s.",
        this_species$scientific_name, start
      ),
      field_description = c(
        sublocation_id = "The identifier of the sublocation.",
        winter = "The year of January 1st during the winter."
...
least %i winters in every sublocation. The dataset starts at %s.",
        this_species$scientific_name, n_winter, n_present, start
      ),
      field_description = c(
        location_id = "The identifier of the location.",
        sublocation_id = "The identifier of the sublocation.",
